        ...
        <v-data-table
              ...
              <template v-slot:no-results>
                ...
                <template v-slot:top>
                    ...
                    <v-toolbar-title>Estado servicio</v-toolbar-title>
                    <v-spacer></v-spacer>
...
export default {
  ...
  methods:{
    ...
    nuevo(){
       this.$router.push({path:`estado-servicio/nuevo`});
    },
    recargar(){
      this.sincronizar = false
      this.obtener_estados()
    ...
    editar_estado(data){
      if(data)
      {
        this.$router.push({path:`estado-servicio/editar/`+data.id});
      }
    },
