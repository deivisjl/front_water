    ...
    methods:{
        ...
        obtener_comite()
        {
            ...
            this.$store.state.services.autorizacionService
                .editAutorizacion(this.$route.params.id)
                .then(r=>{
                    this.loader = false
                    this.model.id = r.data.id,
                    this.model.nombre_comite = r.data.nombre_comite,
                    this.model.municipio = r.data.municipio_departamento,
                    this.model.no_autorizacion = r.data.autorizacion,
                    this.model.no_contraloria = r.data.registro_contraloria,
                    this.fromDateVal = r.data.fecha
                })
                .catch(error=>{
                    this.loader = false
                })
